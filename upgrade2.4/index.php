...
$pos = strpos($configcontents, "UPGRADED2.4");
if ($pos===false) 
{
	;
}//end if
...
//  }//end else
  ...
  if( (empty($val3) || $val3 !=1) or !$mysqlsupport)
  {
...
$directories = array("../images/","../pics/profile/","../lang_flags/","../pics/","../help/","../includes/config.php","../sliders/");
umask(0);
...
{	
	if($OS != "WIN")
	{
		...
		if (!is_writable($sliderdir) || !is_readable($sliderdir) || !@file_exists("$sliderdir"."."))
		{
			$error = true;
...
/*	if( ini_get('safe_mode') )
	...
	else 
	{
        ...
        $final_configcontentNew="define('UPGRADED2.4', true); \n\n?>";
                          ...
                          <tr>
                            <td bgcolor="#EEEEEE"><table width="100%"  border="0" cellspacing="1" cellpadding="4" class="maintext2">
                              ...
                              <tr bgcolor="#FFFFFF">
                                ...
                                <td align="left"><?php echo (( $mysqlsupport) ? "On" : " $ivf This program requires MYSQL support. Please recompile your PHP with MYSQL Support.") . $sc;?></td>
                              </tr>
                              <!-- PHP 5.4 Fix
                              <tr bgcolor="#FFFFFF">
                              ...
                              <tr bgcolor="#FFFFFF">
                                ...
                                <td align="left"><?php echo $val3 = ini_get("file_uploads");
											echo ((!empty($val3) || $val3==1) ? "On" : $ivf . "Off - Please turn on file_uplaods in the php.ini file").$sc;
											?></td>
                              </tr>
<!--                              <tr bgcolor="#FFFFFF">
...
<!--								<form name="frmInstall" method="post" action="" enctype="multipart/form-data">
							...
							?>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;7. Provide write permission (chmod 777 for linux server) of 'sliders' folder. <br>
								&nbsp;&nbsp;&nbsp;&nbsp;8. After the upgradation delete the 'upgrade2.4' folder and its contents.
								<?php }//end if
								  else
								  {
								  		echo 'Please note the following points before you continue:<br>';
								  		echo "&nbsp;&nbsp;&nbsp;&nbsp;1. After the upgradation delete the 'upgrade2.4' folder and its contents.";
								  }//end else
						   ?>				</td>
                              </tr>
							  <?php if(true)
							...
							?>
							  ...
							  <td colspan="2"><b>To ensure complete security, now <br> 
                                  a)You should remove the 'upgrade2.4' directory.<br>
