...
#
    ...
    $x_description = urlencode(SITE_NAME . "::".TEXT_SUCCESS_FEE."::$x_saleid");
#
...
#
    ...
    $ref = SECURE_SITE_URL . "/success_fee_cc.php?payMethod=cc"; // Replace this URL with the URL of this script
