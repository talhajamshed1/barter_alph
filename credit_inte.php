...
#
    ...
    $x_description = urlencode(SITE_NAME . "::".TEXT_PURCHASE_ITEM."::$x_saleid");
#
...
#
    ...
    $ref = SECURE_SITE_URL . "/buycc.php"; // Replace this URL with the URL of this script
    ...
    switch ($details) {
        case "1":
            $cc_flag = true;
            if ($chkAuthorizeMode != "LIVE" && $return[6]==0) $cc_tran = rand (1000, 10000);
            else $cc_tran = $return[6];
            break;
