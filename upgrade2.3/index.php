...
$pos = strpos($configcontents, "UPGRADED2.3");
if ($pos===false) 
{
	;
}//end if
...
/*	if( ini_get('safe_mode') )
	...
	else 
	{
        ...
        $final_configcontentNew="define('UPGRADED2.3', true); \n\n?>";
                        ...
                        <td align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
							...
							?>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;7. After the upgradation delete the 'upgrade2.3' folder and its contents.
								<?php }//end if
								  else
								  {
								  		echo 'Please note the following points before you continue:<br>';
								  		echo "&nbsp;&nbsp;&nbsp;&nbsp;1. After the upgradation delete the 'upgrade2.3' folder and its contents.";
								  }//end else
						   ?>				</td>
                              </tr>
							...
							?>
							  ...
							  <td colspan="2"><b>To ensure complete security, now <br> 
                                  a)You should remove the 'upgrade2.3' directory.<br>
