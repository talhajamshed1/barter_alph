...
if (!$FirstName || !$LastName || !$Address || !$City || !$State || !$Zip || !$CardNum || !$Email || !$CardCode || !$Country || !$Month || !$Year) {
    ...
    $x_description = urlencode(SITE_NAME . "::".TEXT_PAYMENT_REGISTRATION_USER." : " . $var_credit_desc);
