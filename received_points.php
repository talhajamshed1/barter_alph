...
$sqlSent .= " FROM " . TABLEPREFIX . "pointhistory ph LEFT JOIN " . TABLEPREFIX . "users u ON u.nUserId  = ph.nSendBy ";
$sqlSent .= " WHERE ph.nSendTo  = '" . $_SESSION["guserid"] . "' ";
$sqlSent .= $qryopt;
        ...
        <div class="col-lg-9">
          <div class="full-width">
            <div class="innersubheader2 row">
              <div class="col-lg-12">
                <h3><?php echo str_replace('{point_name}',POINT_NAME,HEADING_RECEIVED_POINTS_HISTORY); ?></h3>
              </div>
            </div>
            <div class="space"></div>
          </div>
                    ...
                    <td class="tabContent tabcontent_wrapper">
                        ...
                        <form name="frmSent" method="post" action = "<?php echo $_SERVER['PHP_SELF'] ?>">
                          ...
                          <tr align="center"  class="">
                            ...
                            <th width="34%"><?php echo TEXT_SENT_BY; ?> </th>
