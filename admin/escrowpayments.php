					...
					<div class="col-lg-12">
						...
						<table width="100%"  border="0" cellspacing="1" cellpadding="4" class="table table-bordered">
							<form name="frmAffMain" method="POST" action = "<?php echo $_SERVER['PHP_SELF'] ?>">
								...
								<tr align="center" >
									<td colspan="8">
										<a href="viewalltran.php"><?php echo TEXT_YOUR_PENDING_SETTLEMENT_IS; ?></a> <!--<span class="warning"><?php //echo CURRENCY_CODE; ?><? //echo $amount; ?> <a href="viewalltran.php"><?php //echo LINK_DETAILS; ?></a></span>-->
									</td>
								</tr>
								<tr >
