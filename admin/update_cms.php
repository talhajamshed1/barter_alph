...
$lang_num    = mysqli_num_rows($contRs);
...
<?php require("../includes/adminmenu.php"); ?>
        ...
        <td width="78%" valign="top">
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                <tr>
                    <td width="100%" class="heading_admn" align="left"><span class="boldtextblack">Edit CMS</span></td>
                </tr>
            </table>
            <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                <tr>
                                            ...
                                            <tr bgcolor="#FFFFFF">
                                                ...
                                                <td width="85%" align="left" valign="top">
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php echo ($controw['content_name']=='hintro')?'Welcome Text':ucfirst($controw['content_name']); ?>
                                                        </option>
                                                        <?php
                                                        $k++;
                                                        }
