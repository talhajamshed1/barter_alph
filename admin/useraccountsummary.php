...
$sql= "SELECT nUserId, vFirstName, vLoginName,vLastName, vCity FROM ".TABLEPREFIX."users   " . $qryopt . " where nUserId IN (SELECT nUserId FROM ".TABLEPREFIX."cashtxn)"
        . " order by nUserId  DESC ";

if(!isset($begin) || $begin =="") {
    $begin = 0;
}//end if
$sess_back="useraccountsummary.php?begin=" . $begin . "&num=" . $num . "&numBegin=" . $numBegin . "&ddlSearchType=" . $ddlSearchType . "&txtSearch=" . $txtSearch;
    ...
    <tr>
        ...
        <td width="78%" valign="top">
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="10">
                <tr>
                    <td width="100%" class="heading_admn boldtextblack" align="left">User Settled Account Summary</td>
                </tr>
            </table>
                                ...
                                <td bgcolor="#ffffff" class="noborderbottm"><table width="100%"  border="0" cellspacing="1" cellpadding="4" class="maintext2">
                                        <form  name="frmAdminMain" method="POST" action = "<?php echo $_SERVER['PHP_SELF']?>">
                                            ...
                                            <tr align="right" bgcolor="#FFFFFF">
                                                <td colspan="5"><a href="accountsummary.php"><b>Back</b></a></td>
                                            </tr>
                                            ...
                                            <tr bgcolor="#FFFFFF">
                                                ...
                                                <td align="center" class="maintext"><?php echo '<a href="useracdetails.php?userid='.$arr["nUserId"].'&username='.urlencode($arr["vLoginName"]).'" title="Click here to view details">'.restrict_string_size($arr["vLoginName"],10).'</a>';?></td>
                                                <td align="center"><?php echo '<a href="useracdetails.php?userid='.$arr["nUserId"].'&username='.urlencode($arr["vLoginName"]).'" title="Click here to view details">'.restrict_string_size($arr["vFirstName"],10).'</a>';?></td>
                                                <td align="center"><?php echo '<a href="useracdetails.php?userid='.$arr["nUserId"].'&username='.urlencode($arr["vLoginName"]).'" title="Click here to view details">'.restrict_string_size($arr["vLastName"],10).'</a>';?></td>
                                                <td align="center"><?php echo '<a href="useracdetails.php?userid='.$arr["nUserId"].'&username='.urlencode($arr["vLoginName"]).'" title="Click here to view details">'.restrict_string_size($arr["vCity"],10).'</a>';?></td>
                                            </tr>
                                                    <?php
                                                    $cnt++;
                                                }//end while
