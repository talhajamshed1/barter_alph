...
#
    ...
    $x_description = urlencode(SITE_NAME . "::".str_replace('{point_name}',POINT_NAME,TEXT_BUY_POINTS)."::$x_saleid");
#
...
#
    ...
    $ref = SECURE_SITE_URL . "/buy_credits.php?payMethod=cc"; // Replace this URL with the URL of this script
