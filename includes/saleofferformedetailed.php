...
// | webdesign etc.                                                       |
// +----------------------------------------------------------------------+
function func_saleoffer_forme_detailed($uid = 0, $fid = 0) {
    global $conn;
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            if ($var_uname != "") {
                ...
                echo HEADING_SALES_OFFERS_FOR_ME;
            }//end else
            ?>
            </td>
        </tr>
                    ...
                    <tr>
                        <td bgcolor="#EEEEEE"><table width="100%"  border="0" cellspacing="1" cellpadding="4" class="maintext2">
                                <form name="frmSale" id="frmSale" ACTION="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                                    ...
                                    $targetfile = "saleofferformedetailed.php";
                                ...
                                //checking escrow status
                                    ...
                                    $sql = "Select sd.nSaleId,sd.nUserId,sd.nAmount,sd.nQuantity,sd.dDate,date_format(sd.dDate,'%m/%d/%Y') as 'dDate2',s.vTitle,s.vFeatured,s.nShipping, u.vLoginName from ";
                                    ...
                                    if (mysqli_num_rows($rs) > 0) {
                                        ...
                                        while ($arr = mysqli_fetch_array($rs)) {
                                            ...
                                            <tr bgcolor="#FFFFFF">
                                                ...
                                                <td class="maintext"><?php echo "<a href='" . $detailfile . "?saleid=" . $arr["nSaleId"] . "&userid=" . $arr["nUserId"] . "&dt=" . urlencode($arr["dDate"]) . "&'>" . htmlentities($arr["vTitle"]) . "</a>"; ?></td>
                                                <td><?php echo htmlentities($arr['vLoginName']); ?></td>
                                                <td><?php echo date('m/d/Y', strtotime($arr["dDate2"])); ?></td>
                                            </tr>
                                            <?php
                                            $cnt++;
                                        }//end while
