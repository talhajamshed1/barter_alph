            ...
            if (mysqli_num_rows($result) > 0) {
                if ($row = mysqli_fetch_array($result)) {
                    ...
                    /*mysqli_query($conn, "INSERT INTO " . TABLEPREFIX . "SuccessFee (nUserId,nPurchaseBy,nProdId,nAmount,
                                    ...
                                    '" . $saleid . "','" . $cost . "','" . $redeemPoint . "',now(),'sa')") or die(mysqli_error($conn));*/
                }
            }
...
if(DisplayLookUp('stripedemo')=="NO"){	
    ...
    console.log(Stripe.setPublishableKey("<?php echo DisplayLookUp('stripepubliclive'); ?>"));
	</script>
	<?php
	}
	?>
					...
					<div class="col-lg-12 profile-section-bottom">
						...
						if ($txtPayMethod == 'rp') {
							if (isset($message) && $message != '') {
									...
									?>
									<div class="clearfix"><div class="alert-custom"><?php echo $message; ?></div></div>
						...
						<div class=" main_form_inner subheader">
						...
						<div class="row main_form_inner">
                            <div class="col-sm-6">
    						      <p id="error-message" style="color:red;margin: 0"></p>
						...
						<div class="row main_form_inner">
							...
							<label><?php echo TEXT_CARD_NUMBER; ?><span class="warning">*</span></label>
    							<div class="col-lg-10 col-sm-12 col-md-10 col-xs-12 row">
    								<input type=text name="txtccno" class="form-control" id="id_card_num" size="24" maxlength="16" onBlur="javascript:checkValue(this);" value="<?php echo $CardNum;?>" onKeyUp="getCreditCardType(this.value)">
    							</div>
						...
						<div class="row main_form_inner">
                            <div class="col-sm-12">
    							<label id="replace_code1"><?php echo TEXT_CARD_VALIDATION_CODE; ?><span class="warning">*</span></label>
						...
						<div class="row main_form_inner">
                            <div class="col-sm-12">
    							...
    							<div class="col-lg-5 col-sm-12 col-md-12 col-xs-12 row">
						...
						<div class=" main_form_inner">
							<label><input type="button" name="btPay" id="btPay" class="subm_btt"  value="Pay Now" onClick="javascript:<?php echo ($txtPayMethod != 'sp')?'clickConfirm();':'stripePay()'?>"></label>
						</div>
							<?php
							   }
								else {
