...
$message = str_replace('{site_email}', SITE_EMAIL, ERROR_PAYMENT_PROCESS_CONTACT_EMAIL); //"There was an error in your payment process.Please contact " . SITE_EMAIL . " for details.";
